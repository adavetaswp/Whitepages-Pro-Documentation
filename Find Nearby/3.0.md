...
| ------- | ---- | ---- |
| found_nearby | integer | Number of addresses found within specified radius from lat/long in the request |
| nearby_locations | array | Array of objects containing information about addresses and residents. Contains maximum of 100 results. |
